...
export const avatarRoutes: FastifyPluginAsync = async (app) => {
  ...
  app.get('/me/avatar', { preHandler: requireUser }, async (req): Promise<MyAvatar | null> => {
  ...
  app.post('/me/avatar', { preHandler: requireUser }, async (req, reply) => {
  ...
  app.patch('/me/avatar', { preHandler: requireUser }, async (req): Promise<MyAvatar> => {
  ...
  app.delete('/me/avatar', { preHandler: requireUser }, async (req, reply) => {
  ...
  app.get('/me/avatar/source', { preHandler: requireUser }, async (req, reply) => {
    const { avatar_source_key: key } = await current(req.user!.id);
  ...
  app.get('/users/:userId/avatar/:avatarId', { preHandler: requireUser }, async (req, reply) => {
